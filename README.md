# Oriana Salas - Junior Growth Marketing Portfolio Project

Hi Alex,

Thanks for the unique process. I'm excited to get started.

This document summarizes the technical prerequisites I completed to set up my workspace.

## Tools Installed

I have successfully installed and configured the following technical tools in my environment:

* **Cursor IDE:** The core code editor and workspace.
* **Git:** Essential system software required for cloning and connecting to my GitHub repository.
* **Claude Code Add-on:** AI-powered assistance integrated into the editor (Anthropic).
* **Codex Add-on:** AI coding assistant integrated into the editor (OpenAI).

## Steps Completed

I have chronologically accomplished the following tasks:

1.  **Software Installation:** Downloaded and installed Cursor IDE on my local machine.
2.  **Account Setup & Interconnection:** Created a new GitHub account, which is now successfully linked to my Cursor workspace.
3.  **Core Extension Configuration:** Navigated the marketplace to locate and install both the **Claude Code** and **Codex** extensions.
4.  **GitHub Repository Creation:** Set up a new, public repository on GitHub named `100hires-marketing-challenge`.
5.  **Repository Connection (Cloning):** Established a secure connection between my local machine and the public repository, enabling me to work on project files within Cursor.
6.  **File Initialization:** Created and formatted this `README.md` file directly within the editor.

## Challenges & Solutions

My path had a couple of common technical hurdles that I solved independently:

* **IDE Interface Orientation:**
    * *Issue:* Upon opening Cursor, the application defaulted to a new "Agents" view, which confused me as it did not match typical instructions or show the expected extensions tab.
    * *Solution:* I navigated the menus and discovered how to switch to the classic "Editor Window," which immediately revealed the full suite of developer tools I needed.

* **Missing Cloning Dependency:**
    * *Issue:* While attempting to connect my new repository to Cursor, the standard cloning commands were not appearing, indicating a missing underlying component.
    * *Solution:* Recognizing this as a prerequisite issue, I consulted a brief online tutorial to troubleshoot. This confirmed my system lacked Git. I installed Git, restarted the IDE, and was able to clone the repository successfully.

I'm officially set up and look forward to the next stage of the project.
